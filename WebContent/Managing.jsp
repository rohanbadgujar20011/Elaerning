...
<body style="background-image: url('image/R2.jpg');" background-size:cover
...
%>
	...
	<section class="container">
		<div class="heading">
			<!-- Heading -->
			<h2><b>Our Students</b></h2>
		</div>
		<div class="row">
			<div class="col-md-4">
				<img src="image/56.jpg" alt="" class="img-responsive">
			</div>
			<div id="courses">
		<div class="container">
			<h2><b>Activity Stream</b></h2>
			<div class="row">
				<div class="col-md-4">
