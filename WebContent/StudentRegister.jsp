               ...
               <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                   <li class="nav-item active">
                        <a class="nav-link" href="Studentlogin.jsp"><b>Login Student </b> <span class="sr-only">(current)</span></a>
 		...
 		<div class="container">
			<div class="row">
				...
				<div class="col-sm-7" ><br>
					<h3 class="section-title" style="color:white;">Register Student</h3><br>					
				</div>
			</div>
		</div>
	...
	<div class="container" data-ng-app="userApp">
			<div class="row">&nbsp;</div>
				<div class="row">
					...
					<div class="col-md-4">												
						<form class="form-light mt-20" action="registerstudent" method="post"   >
							...
							<div class="form-group">
								<input type="text" class="form-control ln" placeholder="Enter Last Name" name="lname" required>
							</div><br>
							
							<div class="form-group">
								<input type="text" class="form-control ln" placeholder="Contact" name="Contact" required>
							</div><br>
							<div class="form-group">
								 <select name="Year"  class="form-control ln"  required>
							  ...
							  <div class="form-group">			
               <select name="Branch" class="form-control ln" required>
