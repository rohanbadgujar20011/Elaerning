               ...
               <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                  <ul class="navbar-nav ">
                     ...
                     <li class="nav-item active">
                        <a class="nav-link" href="StudentRegister.jsp"><b>Register Student</b> <span class="sr-only">(current)</span></a>
	...
	<!-- container -->
				...
				<div class="row">
					...
					<div class="col-md-4"><br>
						...
						<h3 class="section-title" style="color:white;text-align:center">Student Login</h3>	<br>					
						<form class="form-light mt-20" action="StudentLogin" method="post">
							...
							<center><button type="submit" class="btn btn-two">Login</button> <br><br>&nbsp;<button type="reset" class="btn btn-two">Clear </button></center>	
